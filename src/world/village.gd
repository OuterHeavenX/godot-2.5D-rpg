...
## All models are board-game scale, so they're scaled 3x to fit the rogue.
...
const BUILDINGS := [
	["res://src/world/buildings/tavern.gltf", Vector3(-11, 0, -7), 20.0, Vector2(1.17, 1.33)],
	["res://src/world/buildings/market.gltf", Vector3(9, 0, -9), -15.0, Vector2(1.80, 1.32)],
	["res://src/world/buildings/blacksmith.gltf", Vector3(17, 0, 3), -90.0, Vector2(1.29, 1.25)],
	["res://src/world/buildings/house_a.gltf", Vector3(-15, 0, 7), 30.0, Vector2(0.80, 0.86)],
	["res://src/world/buildings/house_b.gltf", Vector3(-7, 0, 17), -10.0, Vector2(0.87, 1.10)],
	["res://src/world/buildings/house_a.gltf", Vector3(13, 0, 15), 160.0, Vector2(0.80, 0.86)],
...
func _ready() -> void:
	...
	for spec in BUILDINGS:
		...
		inst.scale = Vector3.ONE * SCALE_3X
		add_child(inst)
		# Collision box, slightly inset from the visual footprint.
		var cs := CollisionShape3D.new()
		var box := BoxShape3D.new()
		var sx := footprint.x * SCALE_3X * 0.92
		var sz := footprint.y * SCALE_3X * 0.92
